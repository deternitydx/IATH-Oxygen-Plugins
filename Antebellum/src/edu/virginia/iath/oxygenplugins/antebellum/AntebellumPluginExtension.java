...
public class AntebellumPluginExtension implements WorkspaceAccessPluginExtension {
	...
	public void applicationStarted(
		...
		pluginWorkspaceAccess.addMenuBarCustomizer(new MenuBarCustomizer() {
			...
			public void customizeMainMenu(JMenuBar mainMenuBar) {
				...
				mainMenuBar.add(new AntebellumPluginMenu(pluginWorkspaceAccess, options),
